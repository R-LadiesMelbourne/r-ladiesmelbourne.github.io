...
## History of R-Ladies Melbourne Inc.

A timeline of this organisation, generated with the [`quarto-timeline`](https://emilhvitfeldt.github.io/quarto-timeline/) extension developed by Emil Hvitfeldt.

::: {.timeline .vertical .tl-label-banner}
::: {.event data-label="2012" style="--tl-color-accent: #88398A;"}
**R-Ladies Founded**
in San Francisco by Gabriela de Queiroz 💜
:::
::: {.event data-label="18-Oct-2016" style="--tl-color-accent: #88398A;"}
**R-Ladies Melbourne Launched**
by Göknur Giner, Sepideh Foroutan, Saskia Freytag, Roxane Legale, Alexandra Graham, Anna Quaglieri, Sooror Zadeh 🚀

![](images/rladiesmelblogo.png){width=100 height=100}
:::
::: {.event data-label="2017" style="--tl-color-accent: #e1b9e2;"}
**2017 Meetups**
...
- Christmas Party
:::
::: {.event data-label="2018" style="--tl-color-accent: #e1b9e2;"}
**2018 Meetups**
...
:::
::: {.event data-label="28-Mar-2019" style="--tl-color-accent: #88398A;"}
**R-Ladies Melbourne Inc.**
R-Ladies Melbourne became R-Ladies Melbourne Inc. on 28th March 2019 🎉
:::
::: {.event data-label="2019" style="--tl-color-accent: #e1b9e2;"}
**2019 Meetups**
...
:::
::: {.event data-label="2020" style="--tl-color-accent: #e1b9e2;"}
**2020 Meetups**
...
:::
::: {.event data-label="2021" style="--tl-color-accent: #e1b9e2;"}
**2021 Meetups**
...
:::
::: {.event data-label="2022" style="--tl-color-accent: #e1b9e2;"}
**2022 Meetups**
...
:::
::: {.event data-label="2023" style="--tl-color-accent: #e1b9e2;"}
**2023 Meetups**
...
:::
::: {.event data-label="2024" style="--tl-color-accent: #e1b9e2;"}
**2024 Meetups**
...
:::
::: {.event data-label="2025" style="--tl-color-accent: #e1b9e2;"}
**2025 Meetups**
...
- End-of-Year Networking Event
:::
::: {.event data-label="Mar-2025" style="--tl-color-accent: #88398A;"}
**R-Ladies+ Rebrand**
from R-Ladies to R-Ladies+, recognising the need to be more explicit about our mission to serve underrepresented gender minorities beyond cis women. A full breakdown of this discussion can be found on the [rladies.org website](https://rladies.org/news/2026/rebrand-launch/).
:::
::: {.event data-label="Apr-2025" style="--tl-color-accent: #88398A;"}
**R-Ladies+ Melbourne Rebrand**
transitioning from R-Ladies Melbourne from April 2025.

![](images/R-Ladies+ Melbourne Logo.png){width=100 height=100}
:::
::: {.event data-label="2026" style="--tl-color-accent: #e1b9e2;"}
**2026 Meetups**

- Data Driven Decision Making for Fantasy Basketball
- Di Cook Award Seminar Watch Party
...
A list of our organising committees over the years. Our committees are appointed following the April–June Annual General Meetings and serve until the following year's meetings.
...
![](images/committee_25_26.png){width="100%"}
:::
...
-   [Cross-chapter TidyTuesday with R-Ladies](https://www.meetup.com/rladies-sydney/events/307276480/?eventOrigin=your_events).
...
-   [R-Ladies Social Night](https://www.meetup.com/rladies-melbourne/events/310287919/)
-   [Plot Twist - Bringing Your ggplot2 Visuals to Life with ggplotly](https://www.meetup.com/rladies-melbourne/events/310808326/)
-   [It Takes a Spark 2025 - Become A Disease Detective](https://github.com/R-LadiesMelbourne/23-10-25-It-Takes-A-Spark)
-   [R-Ladies & SSA Melbourne Social Night: Happy 9th Birthday R-Ladies](https://www.meetup.com/rladies-melbourne/events/311337114/)
-   [R-Ladies at R Dev Days with Dr Heather Turner](https://www.meetup.com/rladies-melbourne/events/311618693/)
-   [End-of-Year Networking Event](https://www.meetup.com/rladies-melbourne/events/311618784/)
-   [Data Driven Decision Making for Fantasy Basketball](https://www.meetup.com/rladies-melbourne/events/313639240/?eventOrigin=group_past_events)
-   [Di Cook Award Seminar Watch Party](https://www.meetup.com/rladies-melbourne/events/313938056/?eventOrigin=group_past_events)
...
-   Kylie Ainslie
-   Maliny Po
-   Outgoing members: Lauren Smith, Belen Prado, Cecilia Rios Teran
:::
...
R-Ladies Melbourne Inc. Organising Committee and Friends past and present in alphabetical order.
...
<summary>Mei DU</summary>

:::::: columns
::: {.column .centre-align width="30%"}
![](images/committee_profiles/Du_Mei.jpeg){.circular-image}

**Current Position**: Research Assistant (Bioinformatics)\
[<img src="images/bluesky-brands-solid.svg" alt="Bluesky" width="15" height="15" style="fill:#666666; margin-right: 5px;"/> <a href="https://bsky.app/profile/mei-du.bsky.social">Bluesky</a>]{style="display:inline-flex; align-items:center;"}\
<i class="bi bi-github"></i> [Github](https://github.com/mei-du)\
<i class="bi bi-linkedin"></i> [LinkedIn](https://www.linkedin.com/in/mei-du/)\
<i class="bi bi-instagram"></i>[Instagram](https://www.instagram.com/diemspace/)\
<i class="bi bi-twitter-x"></i> [Twitter/X](https://x.com/mei__du)\
<i class="bi bi-envelope-fill"></i> [Email](dumeir@gmail.com)
:::
...
::: {.column width="60%"}
**What do you use R for?** Bioinformatics analysis, particularly of transcriptomics (bulk, single-cell, and spatial).

**Favourite R packages**: [tidyverse](https://www.tidyverse.org/)

**Biography**: Mei is a bioinformatician in Melbourne, Australia, dedicated to supporting medical research at MCRI by providing end-to-end biooinformatics analysis support. Her scientific journey began with studying genetics, driven by the desire to dive deep into the instructions and mechanisms that shape us. She also enjoys communicating science and sharing her passion for slow fashion and sustain-able living.
:::
::::::
...
:::::: columns
::: {.column .centre-align width="30%"}
![](images/committee_profiles/McCann_Kirsty.jpg){.circular-image}

**Current Position**: Research Fellow at Deakin University\
<i class="bi bi-linkedin"></i> [LinkedIn](https://www.linkedin.com/in/dr-kirsty-mccann-ab27abb0/)\
<i class="bi bi-github"></i> [Github](https://github.com/KirstyMcCann)
:::
...
::: {.column width="60%"}
**What do you use R for?** Generating figures for publication, visualisation, bioinformatics, statistics, population genetics, data wrangling

**Favourite R packages**: [tidyverse](https://www.tidyverse.org/), [ggplot2](https://ggplot2.tidyverse.org/)

**Biography**: Kirsty is a bioinformatician and genomic epidemiology Research Fellow based at Deakin University in the Centre for Innovation in Infectious Disease and Immunology Research (CIIDIR) within the School of Medicine in Geelong. Kirsty is passionate about streamlining analyses and reproducibility. Many of the population genetic analyses are data visualisation is completed using various R packages. Specifically, her current research focuses on using genetics and population genomics to understand malaria parasite transmission and diversity across malaria endemic countries including Papua New Guinea, Cambodia and Africa. As a bioinformatician, she has expertise in big data analysis and complex population analyses to explore malaria epidemiology and additionally other parasites and bacteria. Kirsty is also passionate in teaching analysis methods and capacity strengthening.
:::
::::::
